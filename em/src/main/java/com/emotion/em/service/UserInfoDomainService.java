...
import com.emotion.em.Entity.*;
import com.emotion.em.repository.*;
...
public class UserInfoDomainService { 
    ...
    @Transactional public UserInfo getUserInfo(String name) {
...
@Transactional public UserInfo createUserInfo(UserInfo userInfo) {
    userInfo = userInfoRepository.save(userInfo);
    return userInfo;
}

@Transactional public void updateUserInfo(UserInfo userInfo) {
    log.debug("userInfo.getId() : " + userInfo.getId());
    UserInfo userinfo1 = userInfoRepository
...
@Transactional public void deleteUserInfo(String name) {
